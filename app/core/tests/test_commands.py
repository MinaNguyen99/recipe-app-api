...
"""
Mock behaviour of database because we need to simulate
...
class CommandTest(SimpleTestCase):
    ...
    def test_wait_for_db_delay(self, patched_sleep, patched_check):
        ...
        side_effect allow to pass in various different items
        that get handle # depend on that type
        if pass E => mock lib raise that E, if pass boolean,
        it returns boolean value
        this allow to define various different values
        that happen each time call it in the order that it'scalled
        """
